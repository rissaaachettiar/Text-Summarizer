...
def get_lang_options():
    url = "https://translate.yandex.net/api/v1.5/tr.json/getLangs?key=trnsl.1.1.20210503T180602Z.4bbb4c52e7bd3986.6a95c6b48a81c85959bd158580e67c3b2d93b352&ui=en"
    response = requests.post(url=url)
    json_obj = response.json()
    langs = json_obj["langs"]
    return langs
...
def main():
    ...
    if choice == 'Summarize Via Text':
        ...
        language_choice = st.selectbox(
            "Language Choice", options=list(langs.keys()), format_func=format_function)
        ...
        if st.button("Summarize Via Text"):
            ...
            response = get_translated_data(summary_result, language_choice)
    ...
    if choice == 'Summarize Via URL':
        ...
        if st.button("Summarize Via URL"):
            ...
            if summary_choice == 'Gensim':
                ...
                summary_result = nltk_summarizer(result)
